...
import 'package:QuickFix/pages/date_time.dart';
...
class _CleaningPageState extends State<CleaningPage> {
                  ...
                  MaterialPageRoute(
                      builder: (context) => DateAndTime(
                          selectedRooms: _selectedRooms
                              .map((index) => _rooms[index][0] as String)
                              .toList())),
                );
              },
              child: Row(
  ...
  Widget room(List<dynamic> room, int index) {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Row(
                  children: [
                    ...
                    SizedBox(width: 10.0),
                    Text(
                      room[0] as String, // Ensure room[0] is cast to String
                      style:
            ...
            if (_selectedRooms.contains(index) && room[3] >= 1)
              Container(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
